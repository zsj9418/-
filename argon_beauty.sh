...
step_glassmorphism() {
    ...
    printf 'body #maincontent .container .cbi-section,\n' >> "$css"
    printf 'body #maincontent .container .cbi-section-node,\n' >> "$css"
    printf 'body #maincontent .container .cbi-map,\n' >> "$css"
    printf 'body #maincontent .container fieldset,\n' >> "$css"
    printf 'body #maincontent .container .panel,\n' >> "$css"
    printf 'body #maincontent .container .card,\n' >> "$css"
    printf 'body #maincontent .container .box,\n' >> "$css"
    printf 'body #maincontent .container .well,\n' >> "$css"
    printf 'body #maincontent .container .cbi-value,\n' >> "$css"
    printf 'body #maincontent .container .cbi-section-descr,\n' >> "$css"
    printf 'body #maincontent .container .cbi-tabcontainer,\n' >> "$css"
    printf 'body #maincontent .container .table,\n' >> "$css"
    printf 'body #maincontent .container .table-striped,\n' >> "$css"
    printf 'body #maincontent .container .table-bordered,\n' >> "$css"
    printf 'body #maincontent .container .cbi-section-table {\n' >> "$css"
    printf '  background: var(--glass-bg) !important;\n' >> "$css"
    printf '  backdrop-filter: brightness(1.1) blur(var(--glass-blur)) saturate(140%%) !important;\n' >> "$css"
    printf '  -webkit-backdrop-filter: brightness(1.1) blur(var(--glass-blur)) saturate(140%%) !important;\n' >> "$css"
    printf '  border: 1px solid var(--glass-border) !important;\n' >> "$css"
